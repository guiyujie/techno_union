...
class Swiper extends Component {
    ...
    render() {
        ...
        let wrapperStyle = {
            ...
            "-webkit-transform": `translate(${ direction === 'horizontal' ? this.state.translate : 0}px, ${ direction === 'vertical' ? this.state.translate : 0}px)`,
            transform: `translate(${ direction === 'horizontal' ? this.state.translate : 0}px, ${ direction === 'vertical' ? this.state.translate : 0}px)`,
            "-webkit-transition": this.state.animating ? `-webkit-transform .${speed / 100}s` : 'none',
